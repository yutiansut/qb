    ...
    return <div className="total-asset clearfix">
        ...
        <div className="item total clearfix">
          ...
          <span>{this.intl.get('asset-totalAssets_v1')}:</span>
            ...
            {this.state.unit === this.intl.get('cny_v1') ? <span>
                ≈ {totalAsset.valuationCN} CNY
              </span> : <span>≈ {totalAsset.valuationEN} USD</span>}
            <div className="select">
              <SelectButton type="main" title={this.state.unit} simple={true} valueArr={[this.intl.get('cny_v1'), this.intl.get('usd_v1')]} onSelect={item => {
        ...
        <div className="item limit">
          ...
          {totalAsset.totalQuota > 2 ? <span className="disable">
            ...
            </span> : <NavLink to="/user/identity">{this.intl.get('asset-limitApply_v1')}</NavLink>}
        </div>
