...
export default class ExchangeViewBase extends ViewBase {
  constructor(props) {
    ...
    this.$imagesMap = {
      ...
      $home_banner_text_cn: "/static/img/banner/textCn.svg",
      $home_banner_text_en: "/static/img/banner/textEn.svg",
      $home_user_notice: "/static/img/home/new_bai.svg",
      $invite: "/static/images/genrealize/invite.png",
      $aside_erweima: "/static/img/erweima.png",
      $help_download_bg: "/static/mobile/help/img_bg.png"
