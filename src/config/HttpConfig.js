...
export default {
  ...
  user: [ // 用户
    ...
    {name: 'getAward', data: {url: '/v1/user/', method: 'post'}, action: 'ga', actionBack: 'gar', needToken: true}, // 领取奖励
  ...
  market: [
    ...
    //平台币资料
    { name: 'getQb', data: { url: '/v1/common/', method: 'post' }, action: 'qd', actionBack: 'qdr' },
    // 获取交易对名称以及id
  ...
  activity: [
    ...
    //TODO 获取QBT信息
    { name: 'getQbtInfo', data: { url: '/v1/common/', method: 'post' }, action: 'qd', actionBack: 'qdr'}
  ],
  login: [
