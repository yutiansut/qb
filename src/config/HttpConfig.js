...
export default {
  ...
  notice: [
    ...
    {name: 'upDateUserNocticeList', data: {url: '/user/', method: 'post'}, action: 'updateUserNotificationStatus', actionBack: 'updateUserNotificationStatusRes', needToken: true}, // 读取通知
  ],
  market: [
    //币种资料
  ...
  asset: [
    ...
    // 获取全部币种列表
    { name: 'getAllCoinList', data: { url: '/common/', method: 'post' }, action: 'getAllCoinList', actionBack: 'getAllCoinListRes'},
  ],
  userOrder:[
    //当前订单
