export default function en(state) {
  ...
  const common = {
    ...
    languageEn: 'English',
    next: 'Next',
    pwdRule: '6 or above combination with letter, number or symbol, must include a capital letter',
    fundPwdRule: 'Please enter 6-digit number',
  ...
  const errMessage = {
    ...
    '629-1': 'Account has been frozen for {number} minutes. One more incorrect input, your account will be frozen for 24 hours.',
    '629-2': 'Account has been frozen for {number} hours. One more incorrect input, your account will be frozen for a week.',
    '629-3': 'Your account has been frozen for {number} days, please contact customer service for any questions.',
    '629-4': 'Your account has been frozen for a week, please contact customer service for any questions.',
    '630-1': 'Wrong password input for 4 times, one more time your account will be frozen for 30 minutes.',
    631: "Password wrong, the account has been banned. Please reset the password and relogin.",
  ...
  const market = {
    ...
    "market-main": "Main Plot",
    "market-new": "Innovation Plot",
  ...
  const user = {
    ...
    "user-checkNewPwd": "*Password format is incorrect",
